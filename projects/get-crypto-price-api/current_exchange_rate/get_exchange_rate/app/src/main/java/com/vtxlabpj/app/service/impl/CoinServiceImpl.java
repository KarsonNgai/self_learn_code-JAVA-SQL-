...
import com.vtxlabpj.app.dto.ExchangeRate;
...
public class CoinServiceImpl implements CoinService{
   ...
   */
  private Map<String, Object> getSimplePriceExchangeRateHelper(String ids, String currencies){
    RestTemplate restTemplate = new RestTemplate();

    @SuppressWarnings("unchecked")
    Map<String, Object> deserFromJson = restTemplate.getForObject(api.generateAPISimplePrice(ids,currencies), Map.class);  
    
    if(Objects.isNull(deserFromJson))throw new NullPointerException();
